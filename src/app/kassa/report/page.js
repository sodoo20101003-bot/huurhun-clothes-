        ...
        <div className="flex rounded-full bg-cream p-1">
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-sm font-semibold transition ${
              activeBranch === "all" ? "bg-ink text-cream" : "text-ink hover:bg-paper"
            }`}
          >
            Бүгд
          </button>
          {Object.entries(BRANCH_LABELS).map(([v, l]) => (
            <button
              ...
              className={`rounded-full px-4 py-1.5 text-sm font-semibold transition ${
                activeBranch === v ? "bg-ink text-cream" : "text-ink hover:bg-paper"
              }`}
            >
              🏪 {l}
            </button>
            ...
            return (
              <div key={d} className="card overflow-hidden">
                ...
                <div className="p-4 border-b border-ink/5">
                  ...
                  ) : <p className="text-sm text-ink-400">Хоосон</p>}
                </div>
